...
```javascript
import hasInt16ArraySupport from 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-int16array-support@v0.2.1-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/assert-has-int16array-support/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/assert-has-int16array-support/actions/workflows/test.yml?query=branch:v0.2.1
