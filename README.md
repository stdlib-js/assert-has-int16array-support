...
```javascript
hasInt16ArraySupport = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-int16array-support@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-int16array-support@umd/bundle.js"></script>
```
