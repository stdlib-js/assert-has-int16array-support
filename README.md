...
```javascript
hasInt16ArraySupport = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-int16array-support@v0.2.0-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/assert-has-int16array-support@v0.2.0-umd/browser.js"></script>
```
